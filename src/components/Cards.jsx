const Cards = () => {
  return (
    <div className='flex flex-col  md:flex-row justify-center lg:justify-evenly flex-wrap gap-3 my-10'>
      <div>
        <div className='bg-white max-w-xs min-h-xs md:w-54 lg:w-64 shadow-lg   mx-auto  border-b-4 border-blue-600 rounded-2xl overflow-hidden  hover:shadow-2xl transition duration-500 transform hover:scale-105 cursor-pointer'>
          ...
          <div className='flex justify-center px-5 mb-2 text-sm '>
            <button type='button' className='border border-blue-600 text-blue-600 rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:text-white hover:bg-blue-500 focus:outline-none focus:shadow-outline'>Ver</button>
          </div>
        </div>
      </div>

      <div>
        <div className='bg-white max-w-xs lg:w-64 mx-auto rounded-2xl  border-b-4 border-blue-600 overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-105 cursor-pointer'>
          ...
          <div className='flex justify-center px-5 mb-2 text-sm '>
            <button
              type='button' className='border border-blue-600 text-blue-600 rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:text-white hover:bg-blue-600 focus:outline-none focus:shadow-outline'
            >
              Ver
            </button>
          </div>
      ...
      <div>
        <div className='bg-white max-w-xs md:w-52 lg:w-64  mx-auto rounded-2xl  border-b-4 border-blue-600 overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform hover:scale-105 cursor-pointer'>
          <div className='h-20 bg-blue-600 flex items-center '>
          ...
          <div className='flex justify-center px-5 mb-2 text-sm '>
            <button type='button' className='border border-blue-600 text-blue-600 rounded-md px-4 py-2 m-2 transition duration-500 ease select-none hover:text-white hover:bg-blue-600 focus:outline-none focus:shadow-outline'>
              Ver
            </button>
          </div>
        </div>
