  ...
  return (
    <section>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-1 justify-center py-16'>
        <div className='col-span-1 row-span-1 lg:mt-10 pl-10'><TitleHome>Tu cuenta digital practica y sin costos</TitleHome></div>
        ...
        <div className='md:row-start-1 row-end-4'>
          <img className='min-w-full md:min-w-0 my-6 lg:min-h-full max-w-xl' src={home} alt='home' />
        </div>
