...
const LoginPage = () => {
  return (
    <section className='flex justify-center items-center'>
      <div className='bg-white shadow rounded lg:w-1/3  md:w-1/2  p-10 mt-32'>
        ...
        <div className='mt-8'>
          <button className='focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700  font-semibold leading-none text-white focus:outline-none bg-blue-600 border rounded hover:bg-purple-600 py-4 w-full text-md'>
            Iniciar
          </button>
        </div>
        ...
        <button
          aria-label='Ingresa con Twitter'
          className='focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4'
        >
          <svg
            width='24'
