            ...
            <div className='inline-block min-w-full shadow rounded-lg overflow-hidden'>
              ...
              >
                ...
                <div className='inline-flex mt-2 xs:mt-0'>
                  <button
                    className='text-sm bg-blue-400 hover:bg-blue-600 text-gray-700 font-semibold py-2 px-4 rounded-l'
                  >
                    Prev
                  </button>
                  <button
                    className='text-sm bg-blue-400 hover:bg-blue-600 text-gray-700 font-semibold py-2 px-4 rounded-r'
                  >
                    Next
                  </button>
                </div>
